...
// improve and vertified test by Alex on Feb 15th
...
void loop()
{
    ...
    //SERIAL_PORT.println( data.header, HEX );
        ...
        if ((data.header & DMP_header_bitmap_Quat6) > 0) // We have asked for GRV data so we should receive Quat6
        {
            ...
            t2 = t2 > 1.0 ? 1.0 : t2;
            t2 = t2 < -1.0 ? -1.0 : t2;
//https://forum.arduino.cc/t/nan-question/343491 for somehow display nan
...
// delay 0.3 secs seems enough smooth through mqtt zhun\after trying (0.2/0.3/0.4/0.5)

            char pitch_data[10];
            snprintf(pitch_data, 10, "%d", int(pitch)); 
